 ...
 * @author Josef Galea
 * 
 * Source: https://gist.githubusercontent.com/josefeg/5781824/raw/a98cfb3bdece3f889503837fc54386889b6ce511/CreditCardNumberGenerator.java
 * 
 * Modifications:
 * 			Make the class a singleton
 * 			Integrate checking account number generation
 * 			Static BIN number (5105)
 * 			Static credit card length
 * 			Generate CVV
 */
public class CardNumberHelper {
	
	private static CardNumberHelper instance = null;
	
	public static synchronized CardNumberHelper getInstace() {
		if(instance==null)
			instance = new CardNumberHelper();
		return instance;
	}
	
	private static final String BIN = "5105";
	private static final String BANK_PREFIX = "222";
     ...
     */
    public String generateCreditCardNbr() {
        ...
        int randomNumberLength = CREDIT_CARD_LENGTH - (BIN.length() + 1);
